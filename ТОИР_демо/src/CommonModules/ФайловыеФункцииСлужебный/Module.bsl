...
Функция ЕстьХранимыеФайлы(ВнешнийОбъект) Экспорт
	...
	Если НЕ ЕстьХранимыеФайлы Тогда
		ПрисоединенныеФайлыСлужебный.ПриОпределенииНаличияХранимыхФайлов(ВнешнийОбъект, ЕстьХранимыеФайлы);
	КонецЕсли;
