...
// Устаревший функционал 2.1.8.
// Заменено на ИнтернетПоддержкаПользователейКлиентСервер.ПроверитьСтрокуНаЗапрещенныеСимволы.
...
// Устаревший функционал 2.1.8.
// Заменено на ИнтернетПоддержкаПользователейКлиентСервер.НайтиЭлементСпискаЗначений.
