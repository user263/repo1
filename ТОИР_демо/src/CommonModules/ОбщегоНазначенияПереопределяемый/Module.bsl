...
Функция ОбработчикиИнициализацииПараметровСеанса() Экспорт
	...
	Обработчики.Вставить("ПарольПользователяДокументооборота",    "ИнтеграцияС1СДокументооборот.УстановитьПараметрыСеанса");
...
Процедура ПриОпределенииОбщихПараметровБазовойФункциональности(ОбщиеПараметры) Экспорт
	...
	ОбщиеПараметры.МинимальноНеобходимаяВерсияПлатформы = "8.3.5.1336";
