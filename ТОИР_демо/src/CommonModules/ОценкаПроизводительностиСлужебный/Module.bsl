...
Процедура ПервоначальноеЗаполнение() Экспорт
	...
	Если ПодсистемаСуществует("СтандартныеПодсистемы.БазоваяФункциональность") Тогда
		МодульОбщегоНазначенияПовтИсп = ОбщийМодуль("ОбщегоНазначенияПовтИсп");
		Если МодульОбщегоНазначенияПовтИсп.РазделениеВключено() Тогда
			Возврат;
		КонецЕсли;
	КонецЕсли;
...
Процедура ПриЗаполненииРазрешенийНаДоступКВнешнимРесурсам(ЗапросыРазрешений) Экспорт
	...
	Если БазоваяФункциональностьСуществует Тогда
		МодульОбщегоНазначенияПовтИсп = ОбщийМодуль("ОбщегоНазначенияПовтИсп");
		Если МодульОбщегоНазначенияПовтИсп.РазделениеВключено() И МодульОбщегоНазначенияПовтИсп.ДоступноИспользованиеРазделенныхДанных() Тогда
			Возврат;
		КонецЕсли;
	КонецЕсли;
...
//      * ОтключенныеПодсистемы                     - Соответствие - Позволяет виртуально отключать подсистемы для целей тестирования.
