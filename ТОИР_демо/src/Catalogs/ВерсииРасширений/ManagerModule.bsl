...
Процедура УстановкаПараметровСеанса(ИменаПараметровСеанса, УстановленныеПараметры) Экспорт
	...
	Если ИменаПараметровСеанса = Неопределено
	 Или ИменаПараметровСеанса.Найти("ПодключенныеРасширения") <> Неопределено Тогда
		...
		ПараметрыСеанса.ПодключенныеРасширения = КонтрольныеСуммыРасширений(Расширения, Ложь);
...
//
//  УчестьПорядокПодключения - Булево - если Ложь, строка описания контрольных сумм
//               будет сформирована без учета порядка подключенных расширений.
//
// Возвращаемое значение:
//  Строка - строки вида "<Имя расширения> (<Версия расширения>) <Контрольная сумма>".
//
Функция КонтрольныеСуммыРасширений(Расширения = Неопределено, УчестьПорядокПодключения = Истина) Экспорт
	...
	Если Не УчестьПорядокПодключения Тогда
