...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если ПроверитьПравоНаКлиенте("Редактирование") Тогда
		Если ЭтаФорма.Элементы.Найти("СписокОбъектов") <> Неопределено
			...
			СтруктураСдвига = торо_НастройкаПорядкаЭлементовКлиент.ПереместитьЭлементВнизВыполнить(ЭтаФорма.СписокОбъектов, ЭтаФорма.Элементы.СписокОбъектов, ЭтаФорма.ТекСтруктураИерархии);
		Иначе
