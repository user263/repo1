...
Процедура ЗаполнитьЧастьАдресаПоПредставлению(НаименованиеЧастиАдреса, Представление, Идентификатор)
	...
	Если НаименованиеЧастиАдреса = "ДополнительныйЭлемент" Тогда
		НаселенныйПунктДетально[НаименованиеЧастиАдреса].ПутьXPath = УправлениеКонтактнойИнформациейКлиентСервер.XPathДополнительногоОбъектаАдресации(90, НаименованиеСокращение.Сокращение);
	ИначеЕсли НаименованиеЧастиАдреса = "ПодчиненныйЭлемент" Тогда
		НаселенныйПунктДетально[НаименованиеЧастиАдреса].ПутьXPath = УправлениеКонтактнойИнформациейКлиентСервер.XPathДополнительногоОбъектаАдресации(91);
	Иначе
