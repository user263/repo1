...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ВидОбработок = Перечисления.ВидыДополнительныхОтчетовИОбработок.ШаблонСообщения Тогда
		ЭтоНазначаемыеОбработки = Истина;
...
Процедура НастроитьСписок(Команда)
	...
	Открытие.Параметры = Новый Структура("ВидОбработок, СсылкаРаздела");
	Открытие.Параметры.ВидОбработок  = ВидОбработок;
	Открытие.Параметры.СсылкаРаздела = СсылкаРаздела;
